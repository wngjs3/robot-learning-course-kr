...
- **한국어 해설** — 영상 재생 위치에 맞춰 구간별 해설이 따라옵니다
- **한국어 자막** — 전체 스크립트의 자연스러운 한국어 번역 (영어 원문 병기 가능)
- **한국어 슬라이드** — 강의 슬라이드를 AI로 번역해 영상과 나란히 표시
- **강의 요약** — 전체 요약, 핵심 포인트, 핵심 용어 정리

## 과제 (한국어판)

공식 과제의 문서·노트북 설명과 코드 주석을 한국어로 번역했습니다. 코드는 원본 그대로이며, 영어 원문은 `*.en.bak`으로 보존되어 있습니다.

| 과제 | 주제 |
|---|---|
| [hw1_pytorch_tutorial](homework/hw1_pytorch_tutorial/) | PyTorch & NumPy 튜토리얼 |
| [hw2_robot_control_mdps](homework/hw2_robot_control_mdps/) | 로봇 제어와 MDP |
| [hw3_imitation_learning](homework/hw3_imitation_learning/) | 모방 학습 |
| [hw4_reinforcement_learning](homework/hw4_reinforcement_learning/) | 강화 학습 |
